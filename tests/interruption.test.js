...
async function runInterruptionTests() {
    ...
    const tracker = new tracker_1.GenerationTracker('session-test-8', 1);
    ...
    const test2Pass = abortSignalFired === true && res2.oldGeneration === 2 && res2.newGeneration === 3 && tracker.currentGeneration === 3;
    console.log(` - Abort signal fired on old tool operation: ${abortSignalFired}`);
